...
const createOrder = async (data: any) => {
  ...
  if (orderDateStr !== bookingDateStr) {
    throw new Error(
      "Order date must match your booking date. You can only order food for the same date as your room booking."
    );
  }
...
const getAllOrders = async (query: any, userId: number, role: string) => {
